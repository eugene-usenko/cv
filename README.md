...
| Item                      | Description                                        
| ------------------------- | -------------------------------------------------- 
| **Programming Languages** | Java(primary), JS/Typescript(primary), Python and Sehll scripting, C/C++   
...
| **CI**                    | TeamCity, Jenkins
| **Tools**                 | Maven, Gradle, Docker, npm, yarn
...
| ------------------------- | -------------------------------------------------- 
| **Customer**              | BE company
| **Involvement Duration**  | 7 years(till now)
